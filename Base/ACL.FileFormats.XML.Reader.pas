...
begin
  ...
  begin
    ...
    case FParsingState.Chars[FParsingState.CharPos] of
      ...
      'e':
        begin
          if StrEqual(FParsingState.Chars, FParsingState.CharPos, ANameEndPos - FParsingState.CharPos, 'encoding') and
      ...
      's':
        begin
          if StrEqual(FParsingState.Chars, FParsingState.CharPos, ANameEndPos - FParsingState.CharPos, 'standalone') and
...
LblContinue:
    ...
    begin
      case AXmlDeclState of
        ...
        2:
          begin
            FStandalone := StrEqual(FParsingState.Chars,
